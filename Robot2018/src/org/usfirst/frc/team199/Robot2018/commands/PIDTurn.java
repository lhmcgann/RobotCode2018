...
public class PIDTurn extends Command implements PIDOutput {
	 ...
	 *            testing
	 */
	public PIDTurn(double targ, DrivetrainInterface dt, SmartDashboardInterface sd, PIDSource ahrs, Robot robot) {
		this(targ, dt, sd, ahrs, false, robot);
	}
	 ...
	 *            testing
	 */
	public PIDTurn(double[] point, DrivetrainInterface dt, SmartDashboardInterface sd, PIDSource ahrs, Robot robot) {
		this.dt = dt;
		this.ahrs = ahrs;
		rob = robot;
	...
	protected void initialize() {
		...
		turnController.setOutputRange(rob.getConst("Output", 0.5) * -1, rob.getConst("Output", 0.5));
		turnController.setContinuous(true);
		turnController.setAbsoluteTolerance(rob.getConst("TurnTolerance", 1));
